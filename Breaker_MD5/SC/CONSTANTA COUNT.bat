...
REM LINE BELOW IS USED FOR MAXIMUM CHARACTER
set STR=000000ZZ 
REM LINE ABOVE IS USED FOR MAXIMUM CHARACTER

title CATZY@CONSTANTA_COUNTER %STR% %date:~4,10% %time%
cls
...
type out.inf
if %STR%== %resh%%resg%%resf%%rese%%resd%%resc%%resb%%resa% goto end
...
echo.
echo CONSTANTA : %elapsed_time% Second
pause>nul
